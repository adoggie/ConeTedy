...
from elabs.fundamental.utils.importutils import *
from elabs.fundamental.utils.useful import Instance
from elabs.fundamental.application import Application,instance
# from elabs.biz.application.srvmgr import ServiceManager

from elabs.fundamental.service import ServiceBase
...
class FlaskService( ServiceBase):
    ...
    def init(self, cfgs, **kwargs):
        #from elabs.fundamental.application.app import instance
    ...
    def select_address(self):
        ...
        :return:
        """
        from elabs.fundamental.utils.network import select_address_port
    ...
    def initHttpServer(self):
        ...
        port = http.get('port', 5000)
        app = self.app
        from elabs.fundamental.utils.use_gevent import USE_GEVENT
    ...
    def stop(self):
        from elabs.fundamental.application.use_gevent import USE_GEVENT
